...
partial class EvaluationCriteriaForm
{
    ...
    private void InitializeComponent()
    {
        ...
        layout.RowStyles.Add(new RowStyle(SizeType.AutoSize)); layout.RowStyles.Add(new RowStyle(SizeType.Absolute, 92F));
        ...
        toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 16F)); toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 130F));
        toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 8F)); toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 135F));
        toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 8F)); toolbar.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 130F));
        toolbar.AutoScroll = true; toolbar.Dock = DockStyle.Fill; toolbar.MinimumSize = new Size(890, 0); toolbar.Padding = new Padding(12); toolbar.BackColor = AppColors.Surface;
        ...
        criteriaGrid.Columns.AddRange(Column("name", "Наименование", 180F, 240), Column("category", "Категория", 95F, 140), Column("range", "Баллы", 50F, 80),
            Column("manager", "Только рук.", 95F, 135), Column("status", "Статус", 75F, 115), Column("order", "Порядок", 60F, 110));
        ...
        AppControlStyles.ApplySecondaryButton(closeButton); CancelButton = closeButton; AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font;
        BackColor = AppColors.Background; ClientSize = new Size(1120, 680); Controls.Add(layout); MinimumSize = new Size(640, 420);
        Name = "EvaluationCriteriaForm"; StartPosition = FormStartPosition.CenterParent; Text = "Критерии аттестации"; ResumeLayout(false);
    }
    private static DataGridViewTextBoxColumn Column(string name, string header, float fillWeight, int minimumWidth) => new() { Name = name, HeaderText = header, FillWeight = fillWeight, MinimumWidth = minimumWidth };
    ...
    private static void ConfigureButton(Button b, string text) { b.Dock = DockStyle.Fill; b.FlatStyle = FlatStyle.Flat; b.Margin = new Padding(0); b.MinimumSize = new Size(120, 42); b.Padding = new Padding(12, 0, 12, 0); b.Text = text; b.Cursor = Cursors.Hand; }
}
