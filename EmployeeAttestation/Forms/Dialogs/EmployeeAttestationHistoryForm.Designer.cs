...
partial class EmployeeAttestationHistoryForm
{
    ...
    private void InitializeComponent()
    {
        ...
        layout.Padding = new Padding(28, 24, 28, 22); layout.RowCount = 4; layout.RowStyles.Add(new RowStyle(SizeType.Absolute, 42F));
        layout.RowStyles.Add(new RowStyle(SizeType.Absolute, 38F)); layout.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        ...
        historyGrid.Columns.AddRange(new DataGridViewTextBoxColumn { HeaderText = "Дата", FillWeight = 60F },
            new DataGridViewTextBoxColumn { HeaderText = "Комиссия", FillWeight = 115F },
            new DataGridViewTextBoxColumn { HeaderText = "Общий результат", FillWeight = 70F },
            new DataGridViewTextBoxColumn { HeaderText = "Решение", FillWeight = 150F },
            new DataGridViewTextBoxColumn { HeaderText = "Статус", FillWeight = 80F });
        ...
        closeButton.DialogResult = DialogResult.Cancel; layout.Controls.Add(footer, 0, 3); CancelButton = closeButton; AutoScaleMode = AutoScaleMode.Font;
        BackColor = AppColors.Background; ClientSize = new Size(980, 620); Controls.Add(layout); MinimumSize = new Size(820, 500);
    ...
    private static void ConfigureButton(Button b, string text, int width) { b.Cursor = Cursors.Hand; b.FlatStyle = FlatStyle.Flat; b.Margin = new Padding(10, 6, 0, 4); b.Size = new Size(width, 42); b.Text = text; }
}
