...
partial class AttestationProcessForm
{
    ...
    private void InitializeComponent()
    {
        ...
        rootLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 56F)); tabs.Dock = DockStyle.Fill; tabs.Font = new Font("Segoe UI", 10F);
        ...
        CancelButton = closeButton; AutoScaleMode = AutoScaleMode.Font; BackColor = AppColors.Background; ClientSize = new Size(1260, 820);
        Controls.Add(rootLayout); MinimumSize = new Size(980, 680); Name = "AttestationProcessForm"; StartPosition = FormStartPosition.CenterParent;
        Text = "Проведение аттестации"; WindowState = FormWindowState.Maximized; ResumeLayout(false);
    }

    private void ConfigureBasicTab()
    {
        basicTab.Text = "Основные данные"; basicTab.BackColor = AppColors.Surface; basicTab.Padding = new Padding(28);
        ...
        for (int i = 0; i < labels.Length; i++)
        {
            ...
            Label name = new() { Dock = DockStyle.Fill, Font = new Font("Segoe UI Semibold", 10F), ForeColor = AppColors.TextSecondary,
                Text = labels[i], TextAlign = ContentAlignment.MiddleLeft };
            values[i].Dock = DockStyle.Fill; values[i].Font = new Font("Segoe UI", 11F); values[i].ForeColor = AppColors.TextPrimary;
            values[i].TextAlign = ContentAlignment.MiddleLeft; panel.Controls.Add(name, 0, i); panel.Controls.Add(values[i], 1, i);
        }
    ...
    {
        evaluationTab.Text = "Оценивание"; evaluationTab.BackColor = AppColors.Surface; evaluationTab.Padding = new Padding(18);
        TableLayoutPanel panel = new() { Dock = DockStyle.Fill, ColumnCount = 1, RowCount = 6 };
        ...
        panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 48F)); panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 54F));
        ...
        averagesPanel.Dock = DockStyle.Fill; averagesPanel.WrapContents = false;
        ...
        evaluationButtons.Dock = DockStyle.Fill; evaluationButtons.FlowDirection = FlowDirection.RightToLeft;
    ...
    {
        decisionTab.Text = "Решение"; decisionTab.BackColor = AppColors.Surface; decisionTab.Padding = new Padding(18);
        TableLayoutPanel panel = new() { Dock = DockStyle.Fill, ColumnCount = 2, RowCount = 7 };
        panel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F)); panel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 30F)); panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 130F));
        panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 30F)); panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 130F));
        panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 30F)); panel.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        ...
        votesGrid.Dock = DockStyle.Fill; votesGrid.RowHeadersVisible = false; votesGrid.Columns.AddRange(
            new DataGridViewTextBoxColumn { Name = "member", HeaderText = "ФИО", FillWeight = 145F, ReadOnly = true },
            new DataGridViewTextBoxColumn { Name = "role", HeaderText = "Роль", FillWeight = 90F, ReadOnly = true },
            new DataGridViewComboBoxColumn { Name = "vote", HeaderText = "Голос", FillWeight = 75F, FlatStyle = FlatStyle.Flat });
        ...
        decisionButtons.Dock = DockStyle.Bottom; decisionButtons.FlowDirection = FlowDirection.RightToLeft;
    ...
    private static void ConfigureButton(Button button, string text, int width) { button.Cursor = Cursors.Hand; button.FlatStyle = FlatStyle.Flat; button.Margin = new Padding(10, 6, 0, 4); button.Size = new Size(width, 42); button.Text = text; }
}
